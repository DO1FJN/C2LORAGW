...
// all codebooks together uses approx. 124KiB memory!
#define CODEBOOK_MEM_ATTR   static const
#define C2_SPLIT_LOOPS    // use splitted loop (quantise.c) - it's faster on ARM and ESP32 arch
